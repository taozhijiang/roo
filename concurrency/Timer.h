...
#ifndef __ROO_CONCURRENCY_TIMER_H__
#define __ROO_CONCURRENCY_TIMER_H__
...
private:
    ...
    void io_service_run() {
        ...
        log_warning("Timer io_service thread running...");
        ...
        log_warning("Timer io_service thread terminated ...");
...
#endif // __ROO_CONCURRENCY_TIMER_H__
